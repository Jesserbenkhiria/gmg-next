...
const AboutArea = () => {
  ...
  return (
    <>
          ...
          <div className="row ac-testimonial-space">
              ...
              <div className="ac-testimonial-info">
                <div className="actestimonial">
                  <div className="actestimonial__icon">
                    <img src="/assets/images/meta/testimonial_thumbnail_1.jpg" alt="" />
                  </div>
            ...
            <div className="col-xl-6 col-lg-6 wow tpfadeRight" data-wow-duration=".5s" data-wow-delay=".7s">
              <div className="ac-testimonial-right">
                <img src="/assets/images/about/about_image_3.jpg" alt="" />
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Video modal start */}
      <VideoModal isVideoOpen={isVideoOpen} setIsVideoOpen={setIsVideoOpen} videoId="8D6b3McyhhU" />
      {/* Video modal end */}
    </>
  );
};
