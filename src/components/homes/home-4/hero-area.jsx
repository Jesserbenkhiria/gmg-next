...
const HeroArea = () => {
  ...
  const hero_contents = {
    ...
    social_links: [
      { id: 1, icon: "fab fa-facebook-f social-icon-1", title: t("social_links.facebook"), link: "http://facebook.com" },
      { id: 3, icon: "fab fa-youtube social-icon-3", title: t("social_links.youtube"), link: "https://www.youtube.com/" },
      { id: 2, icon: "fab fa-twitter social-icon-2", title: t("social_links.twitter"), link: "http://twitter.com" },
    ],
  ...
  return (
    <React.Fragment>
      <div className="tp-hero-area-two pt-130 p-relative fix">
        ...
        {shapes.map((s, i) => (
          <div key={i} className={`ce-hero-shape${s.num ? s.num : ""} d-none d-lg-block`}>
